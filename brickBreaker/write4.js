...
mBricks9 = newBricks(row,col,mBricks9);
mBricks10 = newBricks(row,col,mBricks10);
mBricks11 = newBricks(row,col,mBricks11);
mBricks12 = newBricks(row,col,mBricks12);
    ...
    for (let c = 0; c < brickRow;c++)
    {
      for (let r = 0; r < brickCol;r++)
      {
        if (midBricks[c][r].status === 1)
        {
          ...
          let brickY =  (r* (brickHeight+brickPadding)) + 6.4*brickOffsetTop;
...
/*
    ...
    for(let c=0; c < brickColumnCount; c++){
      ...
      */
      ...
      mbricks(mBricks2,3.7,1.85);
      //4.6 2.85
      mbricks(mBricks3,4.6,1.2);

      mbricks(mBricks4,5.5,.5);
      mbricks(mBricks5,6.4,.5);
      mbricks(mBricks6,7.3,1.2);
      mbricks(mBricks7,8.2,1.85);
      mbricks(mBricks8,9.1,2.4);
      mbricks(mBricks9,10,3.5);
      mbricks(mBricks10,10.9,4.5);
      mbricks(mBricks11,1.9,3.5);
      mbricks(mBricks12,1.05,4.5);
...
function collisionDetection(){
  if (score === ((brickRowCount*brickColumnCount))+2*(brickRow*brickCol)+12*(row*col)){
    ...
    for(c=0; c<brickColumnCount;c++){
        ...
        mbricksColid(mBricks9);
        mbricksColid(mBricks10);
        mbricksColid(mBricks11);
        mbricksColid(mBricks12);
