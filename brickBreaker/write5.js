...
*/
    ...
    for (let c = 0; c < brickRow1;c++)
    {
      for (let r = 0; r < brickCol1;r++)
      {
        ...
        {
          let brickX =  (c* (brickWidth + brickPadding)) +5.4*brickOffsetLeft;
          let brickY =  (r* (brickHeight+brickPadding)) +3*brickOffsetTop;
